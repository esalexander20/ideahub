        ...
        <div className="py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-xl text-white">IdeaHub</span>
            </div>
            <p className="text-sm text-zinc-500 mb-4">
              Where ideas get validated by a community of innovators.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/ideas/new" className="hover:text-white transition-colors">
                  Submit Idea
                </Link>
              </li>
              <li>
